...
es = Elasticsearch(hosts=ES_CONNECTION_STRING, basic_auth=('elastic', 'elastic_pw')).options(ignore_status=400, request_timeout=30)
...
if __name__=="__main__":
    context_variables = {"selected_data_pool": 'news_articles_zh',
                         ...
                         "selected_sources": ["zh_8world", "zh_zaobao"],
                         "selected_domains": [],
                         "selected_projects": [],

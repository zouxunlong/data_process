#!/bin/bash
#PBS -N interactive
#PBS -l select=1:ngpus=8:container_engine=enroot
...
enroot start \
	...
	data \
	bash -c "
	python /data/projects/13003558/zoux/workspace/data_process/normalization/normalization2.py True 2> /data/projects/13003558/zoux/xl_experiment.out 1> /data/projects/13003558/zoux/xl_experiment.out
  "

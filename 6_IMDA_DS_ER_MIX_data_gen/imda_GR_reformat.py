...
for DATASET_NAME in [
    ...
    def reformat_instruction_answer(batch):
        ...
        if re.search("\n", transcription): 
            speaker_information=f"""First Speaker Gender: {first_gender}.
            Second Speaker Gender: {second_gender}.
            Number of speakers: 2"""
        else: 
            speaker_information=f"""Speaker Information: {first_gender}.
            Number of speakers: 1"""
    ...
    data.save_to_disk(os.path.join(ROOT_PATH.replace("/ASR", "/Paralingual"), DATASET_NAME.replace("_ASR_","_GR_")))
...
for DATASET_NAME in [
    ...
    def reformat_instruction_answer(batch):
        ...
        prompt = """
            ...
            Question: What is the gender of the first speaker in the dialogue?
            Answer: The gender of the first speaker is male.
